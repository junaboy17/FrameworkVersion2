...
public class TC_BHOPS_11681_Org_Add_Identifier_Duplicate_Error_Message extends BaseHook{
	...
	public void Add_Identifier_Duplicate_Error_Message(String Module) {
		...
		try{
			...
			Expected ="ERROR Message:\n"
					...
					+ "Organization =" + OrgDHHS + ", Location =" + LocationName + ", EMPLOYER IDENTIFICATION NUMBER ID=" + RandNum8 + ", Start Date=" + Today + ", End Date=null";
